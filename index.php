    ...
    <main>
        <div class="view conversation-view <?php echo $chat_id ? "show" : ""; ?>" id="chat-messages">
            <div class="model-name">
                <i class="fa fa-bolt"></i> Default (GPT-4)
            </div>
            <?php
        ...
        <div id="message-form">
            ...
            <div class="disclaimer">JSoftChat uses the OpenAI ChatGPT API but is not affiliated with OpenAI</div>
        </div>
    </main>
